...
export const pp_data = [
  {
    ...
    reason: `
      Deseaba crear un juego durante mis ratos libres. <br/>
  ...
  },
  {
    ...
    tech: 'HTML5, CSS, JavaScript, jQuery, Firebase Database, API Rest, Extensiones de Google Chrome.',
    reason: `
  ...
  },
  {
    title: 'ASCII Pain(t)',
    type: 'draw',
    short_desc: 'Herramienta de Dibujo',
    tech: 'HTML5, CSS, JavaScript.',
    reason: `
